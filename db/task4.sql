vboxuser@sandeep-vm1:~/zero-to-prod-uptime-an-observability-stack-/db$ sudo -u postgres psql 
...
CREATE DATABASE
postgres=# CREATE USER app.user WITH PASSWORD 'user123'; 
ERROR:  syntax error at or near "."
LINE 1: CREATE USER app.user WITH PASSWORD 'user123';
                       ^
postgres=# CREATE USER app.user WITH PASSWORD 'user@123'; 
ERROR:  syntax error at or near "."
LINE 1: CREATE USER app.user WITH PASSWORD 'user@123';
                       ^
...
ERROR:  syntax error at or near "'2025-11-01 00:00:00'"
LINE 2: FOR VALUES FROM '2025-11-01 00:00:00' TO '2025-12-01 00:00:0...
                        ^
postgres=# CREATE TABLE hc_metrics_2025_11 PARTITION OF hc_metrics
FOR VALUES FROM ('2025-11-01 00:00:00') TO ('2025-12-01 00:00:00');
CREATE TABLE
